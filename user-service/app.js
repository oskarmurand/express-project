...
/**
    this defines an API endpoint / which is the root of the application.
    each endpoint can be defined like this
    this is a GET endpoint meaning that you can
...
/*
    when the /users GET endpoint is queried
